 ...
 * CST8152, Assignment #3, Summer 2004.
...
typedef enum ArithmeticOperators  {PLUS, MINUS, MULT, DIV, NEGATE, POSATE} Arr_Op;
...
typedef union TokenAttribute{
   ...
   int vid_stoffset; /* vid lexeme offset in sym_table */
